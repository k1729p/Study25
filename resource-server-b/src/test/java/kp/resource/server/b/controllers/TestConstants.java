...
class TestConstants {
    ...
    /**
     * The unauthorized access message for official level.
     */
    static final String UNAUTHORIZED_OFFICIAL_MSG = "Unauthorized access to officialInformation";
    /**
     * The unauthorized access message for restricted level.
     */
    static final String UNAUTHORIZED_RESTRICTED_MSG = "Unauthorized access to restrictedInformation";
    /**
     * The unauthorized access message for confidential level.
     */
    static final String UNAUTHORIZED_CONFIDENTIAL_MSG = "Unauthorized access to confidentialInformation";
    /**
     * The unauthorized access message for secret level.
     */
    static final String UNAUTHORIZED_SECRET_MSG = "Unauthorized access to secretInformation";
